...
const SelectMoodSection = () => {
  ...
  return (
    <section className="flex flex-col gap-[16px] w-full h-[93px] ">
      ...
      {/* text 인풋 */}
      <Input
        className="max-w-[442px] h-[48px] rounded-[8px] border-[1px] border-[var(--textarea-border)] bg-[var(--sem-fill-norm)] px-[16px] py-[12px] shadow-none placeholder:text-[var(--indicator-disabled)] placeholder:text-[14px
        max-[700px]:h-[44px]"
