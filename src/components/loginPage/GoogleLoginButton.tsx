export default function GoogleLoginButton() {
  ...
  return (
    <button
      className="w-full w-full h-[56px] rounded-[12px] flex gap-[16px] justify-center items-center bg-[var(--google)] border-[1px] border-[#454545] border-opacity-33 cursor-pointer text-semibold hover:brightness-90"
      onClick={handleLogin}
    >
      <img
