export default function NaverLoginButton() {
  ...
  return (
    <button
      className="w-full h-[56px] flex gap-[16px] justify-center items-center rounded-[12px] bg-[var(--naver)] text-white text-semibold cursor-pointer hover:brightness-90"
      onClick={handleLogin}
    >
      <img
