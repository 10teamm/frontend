...
const SearchSection = () => {
  return (
    <section className="relative w-full flex flex-col items-center overflow-hidden">
      ...
      <nav className="relative w-full flex flex-col items-center justify-start pt-[88px] pb-[36px] z-10 max-[700px]:pt-[60px] max-[700px]:pb-[24px]">
        <div className="max-w-[1200px] w-full h-[109px] mb-[24px] max-[700px]:w-[calc(100%-30px)]">
